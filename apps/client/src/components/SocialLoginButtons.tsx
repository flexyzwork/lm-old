    ...
    <div className="mt-6 space-y-3">
      ...
      >
        <svg className="w-5 h-5 mr-2" viewBox="0 0 48 48">
          <path fill="#EA4335" d="M24 19.6v8.8h12.2C34.9 35 30.3 38 24 38c-8.3 0-15-6.7-15-15s6.7-15 15-15c4.1 0 7.5 1.5 10.3 3.9l-4.6 4.6C27.9 14 26 13 24 13c-6 0-10.9 4.9-10.9 11s4.9 11 10.9 11c5.3 0 9.1-3.4 9.6-7.8H24z"></path>
        </svg>
