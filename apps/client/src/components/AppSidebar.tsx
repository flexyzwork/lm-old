            ...
            >
              <div className="app-sidebar__logo-container group">
                <div className="app-sidebar__logo-wrapper">
                  <Image src="/logo.png" alt="logo" width={25} height={20} className="app-sidebar__logo" />
                  <p className="app-sidebar__title">FLEXYZ</p>
                </div>
        ...
        <SidebarMenu>
          <SidebarMenuItem>
            <SidebarMenuButton asChild>
              <button onClick={() => handleLogout()} className="app-sidebar__signout">
